...
## 使い方
  ...
  ドキュメントはtxtディレクトリ配下において管理します。
  ただしchromeの場合は起動オプションに--allow-file-access-from-filesをつける必要があります。
  
## ライセンス
MIT License。その他依存物は以下を参照。

 - [invisible.js](http://code.google.com/p/invisible-js/)
